    ...
    <form class="layui-form layui-form-pane1" id="alert-form" action="" lay-filter="first">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="name" value="{{$role['name']}}" lay-verify="required|title" maxlength="20" lay-reqText="名称" required placeholder="名称" autocomplete="off" class="layui-input" >
            </div>
        </div>
        <div class="layui-form-item">
